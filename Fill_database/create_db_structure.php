...
class CreateDBStructure {
	...
	public function createTableTeams() {
		$teams = "CREATE TABLE IF NOT EXISTS teams (
					...
					games tinyint(2) DEFAULT 0,
					win tinyint(2) DEFAULT 0,
					draw tinyint(2) DEFAULT 0,
					lose tinyint(2) DEFAULT 0,
					goal_diff tinyint(2) DEFAULT 0,
	...
	public function createTableGameStatistics() {
		$gameStatistics= "CREATE TABLE IF NOT EXISTS game_statistics (
										...
										possession_guest tinyint(2) DEFAULT 50,
										...
										offsides_owner tinyint(2) DEFAULT 0,
										offsides_guest tinyint(2) DEFAULT 0,
